            ...
            <div class="card-body">
                <form method="POST" action="update_note.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="carousel1" class="form-control-file border border-1" style="padding:5px; border-radius:5px;">
                        <?php if ($carousel1 != ""): ?>
                            <div class="mt-3 mb-2 text-center">
                                <img src="<?php echo $carousel1; ?>" width="200" alt="Carousel Image 1" style="width: 500px; height: 400px; ">
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                        <label>Carousel Image 2</label>
                        <input type="file" name="carousel2" class="form-control-file border border-1" style="padding:5px; border-radius:5px;">
                        <?php if ($carousel2 != ""): ?>
                            <div class="mt-3 mb-2 text-center">
                                <img src="<?php echo $carousel2; ?>" width="200" alt="Carousel Image 2" style="width: 500px; height: 400px; ">
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                        <label>Carousel Image 3</label>
                        <input type="file" name="carousel3" class="form-control-file border border-1" style="padding:5px; border-radius:5px;">
                        <?php if ($carousel3 != ""): ?>
                            <div class="mt-3 mb-2 text-center">
                                <img src="<?php echo $carousel3; ?>" width="200" alt="Carousel Image 3" style="width: 500px; height: 400px; ">
                            </div>
                        <?php endif; ?>
                    </div>
